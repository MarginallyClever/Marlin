...
#define STRING_CONFIG_H_AUTHOR "(Marginally Clever)" // Who made the changes.
...
#define CONFIGURABLE_MACHINE_NAME "Makelangelo 5"  // Add G-code M550 to set/report the machine name
