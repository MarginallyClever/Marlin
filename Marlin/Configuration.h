...
#define STRING_CONFIG_H_AUTHOR "(Marginally Clever Robots Ltd, linear stewart platform)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_PRO_V1_2  // See https://www.youtube.com/watch?v=UW26KmYl1FE
#endif
...
#define CUSTOM_MACHINE_NAME "Stewart platform"
...
#define K_DRIVER_TYPE  DRV8825 // TMC2209
...
// Dust says "Marlin can only guess what weirdness your up to within limits some things 
// you just have to actually define yourself
...
#define HOMING_FEEDRATE_MM_M { (5*60), (5*60), (5*60), (5*60), (5*60), (5*60) }
